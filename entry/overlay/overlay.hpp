...
inline std::vector<std::pair<int, std::string>> BackList = {
	{246, "BackPack Level 1"},
	{247, "BackPack Level 2"},
	{248, "BackPack Level 3"},
	{249, "BackPack Level 4"}
};

inline std::vector<std::pair<int, std::string>> knockedShield = {
	{242, "Knocked Shield Level 1"},
	{243, "Knocked Shield Level 2"},
	{244, "Knocked Shield Level  3"},
};
